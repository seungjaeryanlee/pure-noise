"""
This is a script from Bazinga699/NCL (Li et al., 2022) to prepare data.

See `prepare_data.py` to see how it is used - you should not need to run this file yourself.
...
# NOTE(seungjaeryanlee): Since we use TF 2.0, we need to add this
